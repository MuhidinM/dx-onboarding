    ...
    description: (
      <div>
        <p className="mb-2">
          ...
          transfers through their Coopbank Diaspora Accounts.
        </p>
        <p>
    ...
    description: (
      <div>
        <p className="mb-2">
          ...
          account management, fund transfers, and bill payments, users can
          handle their banking needs directly from their smartphones.
        </p>
        <p>
          Designed with security in mind, the app provides robust protection
          through biometric login and real-time notifications. CoopBank ensures
